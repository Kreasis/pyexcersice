...
class Game:
    def __init__(self):
        self.size = 4
        self.card_options =["Add", "Boo", "Cat", "Far",
                            "Fat", "Car", "Gum", "Hut"]
    ...
    def check_location(self, time):
        while True:
            ...
            if guess.upper() in self.locations:
                ...
                print("That's not a valid locationn. it should look like this: A1")
    ...
    def start_game(self):
        ...
        while game_running:
            ...
            if self.check_match(guess1, guess2):
                ...
                input("Those cards are not matched")
        print("GAME OVER")      
